          ...
          <div className="navbar-right desktopView">
            <div className="first">
              ...
              <a className="mx-3 flex" href="/products">
                ...
                <svg fill="#000000"   width="12px"
                    height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M11.178 19.569a.998.998 0 0 0 1.644 0l9-13A.999.999 0 0 0 21 5H3a1.002 1.002 0 0 0-.822 1.569l9 13z"></path></g></svg>
                </span>
              </a>
              <NavLink className="mx-3 flex gap-2" to="/login">
                {" "}
                <span className="mt-1">My Accounts </span>
                <span className="">
                  <svg
                    width="25px"
                    height="25px"
          ...
          >
            <div className="mobileView">
              <div className="">
                ...
                <span>
                <svg width="26px" height="26px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--emojione" preserveAspectRatio="xMidYMid meet" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><circle cx="32" cy="32" r="30" fill="#00000"></circle><path d="M37.7 18.1c2 .7 3.7 1.9 4.9 3.7c1 1.4 1.7 3 2.1 4.7s.6 3.3.6 4.8c0 3.9-.8 7.1-2.3 9.8c-2.1 3.6-5.3 5.4-9.7 5.4H20.7v-29h12.5c1.8 0 3.3.2 4.5.6m-11.1 4.4v18.9h5.6c2.9 0 4.9-1.4 6-4.2c.6-1.5.9-3.4.9-5.5c0-3-.5-5.2-1.4-6.8c-.9-1.6-2.8-2.4-5.5-2.4h-5.6" fill="#ffffff"></path></g></svg>
                </span>
