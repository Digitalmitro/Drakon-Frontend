          ...
          >
            <div className="mobileView">
              <div className="">
                ...
                <NavLink className="mx-3 flex" to="/login">
                  {" "}
