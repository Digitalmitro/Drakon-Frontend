...
const CategoryPage = () => {
  ...
  return (
    <Layout>
      <div className='category-page-container my-3' style={{ display: 'flex' }}>
        {/* Left Sidebar */}
            ...
            {filteringLoading ? (
              ...
              currentProducts.length === 0 ? (
                ...
                currentProducts.map(product => (
                  <NavLink key={product._id} to={`/product-details/${product._id}`} style={{ textDecoration: 'none', flexBasis: 'calc(33% - 20px)' }}>
