      ...
      <nav className="flex mb-6" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          <li className="inline-flex items-center">
            <a href="/" className="text-sm text-gray-700 hover:text-blue-600 inline-flex items-center">
              Home
            </a>
          </li>
          <li>
            <div className="flex items-center">
              ...
              <a href="/blog" className="text-sm text-gray-700 hover:text-blue-600 ml-1 md:ml-2">
                Blog
              </a>
            </div>
          </li>
          <li aria-current="page">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-500 ml-1 md:ml-2 font-medium">{post.title}</span>
            </div>
          </li>
        </ol>
      </nav>
