...
import cap from "../assets/carousel/cap.png";
    ...
    <>
      <div className="container-fluid relative flex justify-center items-center">
        <motion.h2
          ...
          className="absolute  transform pt-4 -translate-x-1/2 -translate-y-1/2 text-white text-5xl font-semibold"
        >
          About Us
        </motion.h2>
        <img src={aboutus} alt="About Us" className="w-full mt-16" />
      </div>

      <section style={{ backgroundColor: "#f3f3f3" }}>
        <div>
          <div className="container mx-auto py-32 px-10 lg:px-0 hidden lg:block">
            ...
            <div className="grid grid-cols-3 gap-y-5">
              ...
              <div className="w-[400px] h-[400px]  lg-w-full lg:h-full lg:p-10  rounded-[50%] flex justify-center items-center">
                <img src={cap} alt="" />
              </div>
              <div className=" ml-32">
        ...
        <div className="container">
          <div className="row py-4">
            <div className="col-md-6">
              ...
              <p className="my-3" style={{ lineHeight: "35px" }}>
              ...
              <button type="btn" className="orange">
                Learn more
              </button>
            </div>
            <div className="col-md-6">
              <img
                src={
                  "https://res.cloudinary.com/dinitjlyf/image/upload/v1742466715/chat_uploads/knqnzz6oogu6bvx4dcdi.jpg"
                }
              ></img>
            </div>
          </div>
